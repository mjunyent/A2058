...
//    void setWindowResizeCallback(void(*resizeCallback)(int, int));
    void setWindowResizeCallback(std::tr1::function<void(int,int)> resizeCallback);
//    void setWindowRefreshCallback(void(*refreshCallback)());
    void setWindowRefreshCallback(std::tr1::function<void()> refreshCallback);
//    void setWindowFrameBufferResizeCallback(void(*FBresizeCallback)(int, int));
    void setWindowFrameBufferResizeCallback(std::tr1::function<void(int, int)> FBresizeCallback);
    
//    void setKeyCallback(void(*keyCallback)(int, int, int, int));
    void setKeyCallback(std::tr1::function<void(int, int, int, int)> keyCallback);
//    void setMouseButtonCallback(void(*mouseButtonCallback)(int, int, int));
    void setMouseButtonCallback(std::tr1::function<void(int, int, int)> mouseButtonCallback);
//    void setCursorPosCallback(void(*cursorMoveCallback)(double, double));
    void setCursorPosCallback(std::tr1::function<void(double, double)> cursorMoveCallback);
    ...
    std::tr1::function<void(int,int)> resizeCallback;
    std::tr1::function<void()> refreshCallback;
    std::tr1::function<void(int, int)> FBresizeCallback;
    std::tr1::function<void(int, int, int, int)> keyCallback;
    std::tr1::function<void(int, int, int)> mouseButtonCallback;
    std::tr1::function<void(double, double)> cursorMoveCallback;
    /*
